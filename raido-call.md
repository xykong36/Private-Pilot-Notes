...
* FLY RUNWAY HEADING: 
  * Maintain the heading that corresponds with the extended centerline of the departure runway -- without applying correction for wind drift. 直接头朝向runway centerline 不需要根据风向调整
* Stand By
...
没有establish的情况下就不能通过Airspace, 必须绕行. remain clear of the airspace
